...
export function PropietarioSidebar() {
  ...
  const { solicitudes, intake, mantenimiento } = useNavCounts(true)
  ...
  return (
    <aside className="relative flex w-64 flex-col bg-green-100 text-green-900 overflow-hidden">
      ...
      <Link href="/propietario/dashboard" className="relative flex justify-center border-b border-green-300 py-4">
      ...
      <nav className="relative flex-1 space-y-2 p-4">
        ...
        <Link href="/propietario/reportes" className="block rounded p-2 transition hover:bg-green-200">
          {t.sidebar.reportes}
        </Link>
