-- Actualizar función obtener_datos_contrato para incluir porcentaje_garantia
...
RETURNS TABLE(
  ...
  contrato_porcentaje_garantia NUMERIC,
...
COMMENT ON FUNCTION obtener_datos_contrato IS 'Retorna todos los datos necesarios para generar un contrato de arrendamiento en PDF, incluyendo porcentaje de garantía dinámico';
