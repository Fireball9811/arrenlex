...
export default function AdminOtrosGastosPropiedadPage() {
  const { t } = useLang()
    ...
    <div>
      ...
      <div className="grid grid-cols-1 md:grid-cols-4 gap-4 mb-6">
        ...
        <Card>
          ...
          <CardContent>
            <p className="text-2xl font-bold text-sky-700">{formatValor(resumen.totalGastado)}</p>
          </CardContent>
        </Card>
        <Card>
          <CardHeader className="pb-2">
                    ...
                    <tr key={g.id} className="border-b">
                      ...
                      <td className="p-2">
                        <div className="flex flex-wrap gap-1">
                          ...
                          <Link
                            href={`/admin/otros-gastos/${g.id}/editar`}
                            className="inline-flex items-center rounded border px-2 py-1 text-xs font-medium hover:bg-muted transition-colors"
